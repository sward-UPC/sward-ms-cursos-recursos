"""Entorno Alembic (async) para sward-ms-cursos-recursos.

- La URL se toma de `settings.database_url` (postgresql+asyncpg), igual que la app.
- `version_table = alembic_version_cursos_recursos`: cada microservicio versiona
...
VERSION_TABLE = "alembic_version_cursos_recursos"
